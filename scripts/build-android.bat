...
echo Compiling armeabi-v7a...
    if [%BUILD_DEBUG%]==[1] (
        ...
        cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=armeabi-v7a -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Debug %PROJECT_CMAKE_DIR%
    ...
    cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=armeabi-v7a -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Release %PROJECT_CMAKE_DIR%
...
echo Compiling arm64-v8a...
    if [%BUILD_DEBUG%]==[1] (
        ...
        cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=arm64-v8a -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Debug %PROJECT_CMAKE_DIR%
        if %ERRORLEVEL% NEQ 0 goto ERROR
    ...
    cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=arm64-v8a -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Release %PROJECT_CMAKE_DIR%
...
echo Compiling x86...
    if [%BUILD_DEBUG%]==[1] (
        ...
        cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=x86 -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Debug %PROJECT_CMAKE_DIR%
        if %ERRORLEVEL% NEQ 0 goto ERROR
    ...
    cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=x86 -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Release %PROJECT_CMAKE_DIR%
...
echo Compiling x86_64...
    if [%BUILD_DEBUG%]==[1] (
        ...
        cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=x86_64 -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Debug %PROJECT_CMAKE_DIR%
        if %ERRORLEVEL% NEQ 0 goto ERROR
    ...
    cmake -G Ninja -DCMAKE_TOOLCHAIN_FILE=!ANDROID_TOOLCHAIN! -DANDROID_ABI=x86_64 -DANDROID_PLATFORM=android-21 -DCMAKE_BUILD_TYPE=Release %PROJECT_CMAKE_DIR%
